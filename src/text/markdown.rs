...
pub fn sanitize_markdown_mastodon(markdown_text: &str) -> String {
...
pub fn walk_mastodon(writer: &mut impl Write, children: Vec<Node>) -> FmtResult {
...
pub fn strip_utm_source(url: &str) -> String {
